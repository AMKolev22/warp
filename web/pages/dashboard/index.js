  ...
  return(
    <div id ="dashboard flex flex-row" >
      <div className="flex flex-col items-start  __sidebar max-w-[30%] float-left">
        <Image src={blackLogo} priority={true} className='mt-20 ml-24 ' /> 
        <hr className='w-full mt-8 ml-24 opacity-20 opacity-[1] max-w-[30%]' />
        ...
        <div className='mt-24 __account'>
          ...
          <__Icon path={rocket} header="Sign Up" />
        ...
        <div className='mt-24 __contact'>
          ...
          <__Icon path={issue} header="Report Issue" />
        ...
        <div className='flex flex-col justify-center items-center tracking-wider w-[23rem] h-[4rem] bg-white mt-20 ml-24 rounded-lg text-center text-[2rem] font-medium' style={{fontFamily:'Inter, sans-serif', color: "#121212"}} id = "cust-sh">
      ...
      <div className='flex flex-col __panel w-[70%]'>
        ...
        <h1 className='opacity-100 text-[2.4rem] tracking-wider font-semibold ml-24 mt-8' style={{fontFamily:'Inter, sans-serif', color: "#121212"}}>Welcome back, Nermo 9w.</h1>
      </div>
    </div>
  )
}
